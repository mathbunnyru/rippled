...
if ("${CCACHE_PATH}" MATCHES "chocolatey")
  ...
  # Chocolatey uses a shim executable that we cannot use directly, in which case
  # we have to find the executable it points to. If we cannot find the target
  # executable then we cannot use ccache.
...
set(CMAKE_VS_GLOBALS "CLToolExe=cl.exe" "CLToolPath=${CMAKE_BINARY_DIR}"
