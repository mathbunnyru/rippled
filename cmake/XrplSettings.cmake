...
if (tests)
  # This setting allows making a separate workflow to test fees other than
  # default 10
...
if (is_gcc OR is_clang)
  ...
  set(coverage_format "html-details"
      CACHE STRING "Output format of the coverage report."
  )
...
if (is_linux AND NOT SANITIZER)
  ...
  # Set a default value for the log flag based on the build type. This provides
  # a sensible default (on for debug, off for release) while still allowing the
  # user to override it for any build.
  ...
  set(BUILD_SHARED_LIBS OFF
      CACHE BOOL "build shared xrpl libraries - OFF for win/macos" FORCE
  )
...
if (WIN32)
  option(beast_disable_autolink
         "Disables autolinking of system libraries on WIN32" OFF
  )
else ()
